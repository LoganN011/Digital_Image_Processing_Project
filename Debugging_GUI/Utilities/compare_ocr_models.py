...
Usage:
  python compare_ocr_models.py test_poster.png  --parseq-no-preprocess

No preprocessing for all OCR models:
  python compare_ocr_models.py test_poster.png --no-preprocess

No preprocessing for PARSeq only:
  python compare_ocr_models.py test_poster.png --parseq-no-preprocess

Faster debug:
  python compare_ocr_models.py test_poster.png --no-paddle --no-trocr

Optional:
  python compare_ocr_models.py test_poster.png --gpu
"""
